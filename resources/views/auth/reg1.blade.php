    ...
    <div class="container overflow-hidden">
      ...
      <div class="multisteps-form">
        ...
        <div class="row">
          ...
          <form  action="{{ route('reg2.store') }}" method="POST">
              @csrf
              <!--single form panel-->
                      ...
                      <div class="profile-row">
                        ...
                        <div class="desc">
                          <h3>{{ $nid_details->name }}</h3>
                              ...
                              <input type="hidden" name="date_of_birth" value="{{ $nid_details->date_of_birth }}"/>
                              <input type="hidden" name="gender" value="{{ $nid_details->gender }}"/>
                              <input type="hidden" name="permanent_address" value="{{ $nid_details->permanent_address }}"/>
                        </div>
                        @else
